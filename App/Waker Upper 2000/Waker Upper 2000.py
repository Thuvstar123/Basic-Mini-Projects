...
face_flow=cv2.CascadeClassifier("haarcascade_eye.xml")
...
while True:
    ...
    faces=face_flow.detectMultiScale(gray,scaleFactor=1.3,minNeighbors=7,minSize=(50,50))
    ...
    match number_people:
        ...
        case "1":
            ...
            if mixer.get_busy()==False:
                song=mixer.Sound("C:/Users/suguu/Documents/Apps/Python/Learning/App/Waker Upper 2000/snore-mimimimimimi.mp3")
                song.play()
            else:
                mixer.unpause()
        case "0":
            ...
            if mixer.get_busy()==False:
                song=mixer.Sound("C:/Users/suguu/Documents/Apps/Python/Learning/App/Waker Upper 2000/your-phone-linging.mp3")
                song.play()
            else:
                mixer.unpause()
